...
const NotificationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await callApi('/notifications', newNotification, 'post');
      toast.success('Tạo thông báo thành công!');
      setTimeout(() => {
        navigate(`${basePath}/notifications`, { state: { successMessage: 'Tạo thông báo thành công!' } });
      }, 1000);
    } catch (error) {
      ...
      if (error.code === 'VALIDATION_ERROR' && error.validationErrors) {
        ...
        // Set field errors để hiển thị trên form
      ...
      <div className="card shadow-sm">
        <div className="card-header bg-primary text-white">
          <h3 className="card-title">
            <i className="fas fa-bell me-2"></i> Tạo Thông Báo
          </h3>
        </div>
            ...
            <div className="d-flex justify-content-end gap-2">
              ...
              <button type="submit" className="btn btn-primary" disabled={loading}>
                {loading ? (
                  ...
                  <>
                    <i className="fas fa-save me-1"></i> Tạo
                  </>
                )}
              </button>
            </div>
